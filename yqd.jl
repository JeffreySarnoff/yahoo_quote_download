...
The historical data of Open, High, and Low are already adjusted. In older API download, these data fields are not adjusted. The adjustment of the historical data obtained through this new API did not take into account of dividend (while the adjustment through the old API did).
...
The order of the rows for splits/dividends seems random and is not chronically ordered.
